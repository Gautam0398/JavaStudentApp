...
public class score {
    ...
    public void insertUpdateDeleteStudent(char operation,Integer Sid,Integer Cid,Double scr,String descp) throws SQLException
    {
     ...
     void fillScoreJtable(JTable jTable1) {
        Connection con=MyConnection.getConnection();
         PreparedStatement ps;
        try {
      ...
      void ShowAllScores(JTable jTable1) {
        Connection con=MyConnection.getConnection();
         PreparedStatement ps;
        try {
